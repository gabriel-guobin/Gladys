...
分散式练习对学习的影响是多元的。虽然集中学习（ 例如，死记硬背 ）促进短效学习效果，但分散学习（ 例如分散式教学，尝试性学习或试训练 ）促进长期记忆保持。分散学习对长时记忆的益处，称为间隔效应。通过对各种任务和材料、学习者（ 人类和动物 ）的类型和时间尺度的研究，已经证明间隔效应是是整个记忆科学研究史上最可靠的、普遍度最高的研究结果之一。
